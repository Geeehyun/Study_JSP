...
<form name="frmRegist" id="frmRegist" action="postOK.do" method="post">
<input type="hidden" name="flag" value="regist"/>
<table  class="border">
	<tr>
		<td width="200">작성자</td>
		<td width="600"><input type="text" name="user_id" id="user_id" value="${sessionScope['user_id']}" readonly/></td> 
	</tr>
	<tr>
		<td width="200">제목</td>
		<td colspan="3"><input type="text" name="title" id="title" value="${requestScope['title']}"  maxlength="100"/></td>
	</tr>
	<tr>
		<td width="200">내용</td>
		<td colspan="3">
			<textarea name="content" id="content" rows="10" cols="80">${requestScope['content']}</textarea>
		</td>
	</tr>
</table>
