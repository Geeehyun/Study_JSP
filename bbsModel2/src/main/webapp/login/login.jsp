...
<script>
//기존 로그인 정보 여부 체크
if (${(sessionScope["user_id"] != null) ? true : false}) {
	alert("이미 로그인되어있습니다. 게시판 리스트로 이동합니다.");
...
<form action="loginOK.do" method="post" id="frmLogin">
	<table class="border">
			<tr>
				<td>아이디 : <input type="text" name="user_id" id="user_id" value="test" placeholder="아이디" /></td>
				<td>비밀번호 : <input type="password" name="pwd" id="pwd" value="1234" placeholder="비밀번호" /></td>
